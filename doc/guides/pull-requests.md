...
More details to come on Project Owl dependencies. In case of doubt, open an issue in the
[issue tracker](https://github.com/Project-Owl/owl/issues/) or engage on the 
[Project Owl Slack workspace][].
...
Fork the project [on GitHub](https://github.com/Project-Owl/owl) and clone your fork
locally.
...
Project Owl does not yet have a style guide.
...
Fixes: https://github.com/Project-Owl/owl/issues/1337
Refs: http://eslint.org/docs/rules/space-in-parens.html
```

If you are new to contributing to Project Owl, please try to do your best at
...
This ensures that your working branch has the latest changes from `Project-Owl/owl`
master.
...
at least two Project Owl Collaborators (one Collaborator approval is enough if the
...
All Project Owl contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Project Owl?
2. Does this change make Project Owl better, even if only incrementally?
...
Project Owl Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Project Owl better, but the individual might just
not want to have anything to do with Project Owl ever again. The goal is not just
having good code.
...
Any Project Owl core Collaborator (any GitHub user with commit rights in the
`Project-Owl/owl` repository) is authorized to approve any other contributor's
...
### Accept that there are different opinions about what belongs in Project Owl

Opinions on this vary, even among the members of the Technical Steering
Committee.

One general rule of thumb is that if Project Owl itself needs it (due to historic
or functional reasons), then it belongs in Project Owl.
...
make Project Owl better. These may or may not make sense to add, but as with all
...
Project Owl has always optimized for speed of execution. If a particular change
can be shown to make some part of Project Owl faster, it's quite likely to be
...
That said, performance is not the only factor to consider. Project Owl also

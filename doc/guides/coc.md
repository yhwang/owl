...
Project Owl has a [Code of Conduct][] that *all* contributors are
expected to follow. This code describes the *minimum* behavior expectations
for all contributors.

As a contributor to Project Owl, how you choose to act and interact towards your
...
All contributors to OWL tacitly agree to abide by both the letter and

...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Project Owl, creating a new issue in the `Project-Owl/owl`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `Project-Owl/owl` in a concrete and reviewable manner.

## Asking for General Help

The best place to ask for help is through the [Project Owl Slack workspace][]. Open an
...
of the [Project Owl Slack workspace][].

## Submitting a Bug Report

When opening a new issue in the `Project-Owl/owl` issue tracker, please provide as much
